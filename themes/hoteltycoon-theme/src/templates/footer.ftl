<footer class="fjord-bg-primary footer py-5 text-white-50">
  <div class="container">
    <div class="row">
      ...
      <div class="border-secondary border-top col-12 mt-5 pt-5">
        <p class="mb-0 small text-center text-md-left">
          <@liferay.language key="powered-by" /> <a href="https://www.liferay.com/services/training" rel="external" target="_blank">Hotel Tycoon</a>
        </p>
      </div>
    </div>
  </div>
